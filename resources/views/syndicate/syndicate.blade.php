...
@section("content")
    ...
    <div class="max-w-7xl mx-auto w-full flex flex-col gap-8 p-7 md:p-20">
        <h1 class="text-[#138942] font-sans font-bold text-3xl leading-[40px] self-stretch">
            Sindicato
        </h1>
        ...
        <div class="flex flex-col gap-4">
            <h1 class="text-[#138942] font-sans font-bold text-2xl self-stretch">
        ...
        <h1 class="text-[#138942] font-bold text-2xl self-stretch">
            Diretoria
        </h1>
