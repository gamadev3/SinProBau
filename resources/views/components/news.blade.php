<div class="flex flex-col md2:flex-row shadow-md rounded-2xl overflow-hidden">
    ...
    <div class="md2:w-2/3 flex flex-col gap-4 px-6 py-5 flex-1">
        ...
        <a href="/noticia/{{ $id }}" class="w-fit mt-auto text-[#138942] hover:text-white border border-[#138942] hover:bg-[#1B5E1F] focus:ring-4 focus:outline-none focus:ring-[#A5D6A7] font-medium rounded text-base px-5 py-2.5 text-center">Saiba mais</a>
    </div>
</div>
