<div class="mb-8">
    <label class="block mb-2 text-sm font-medium text-gray-900" for="file_input">Diploma/holerite</label>
...
<div class="grid gap-8 mb-8 md:grid-cols-3">
    ...
    <div>
        <label for="default-datepicker" class="block mb-2 text-sm font-medium text-gray-900">Data</label>
