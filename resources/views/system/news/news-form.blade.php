...
@section("content")
    <div class="max-w-7xl mx-auto w-full flex flex-col gap-8 p-7 md:px-20 md:py-20">
        ...
        <form method="POST" action="/sistema/noticia-registrar" enctype="multipart/form-data" class="w-full md:px-4 py-4">
            @csrf
            @method("POST")
            <div class="flex flex-col gap-10 mb-6">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex">
                        ...
                        <label for="salary_campaign" class="ms-2 text-sm font-medium text-gray-900">Sim, faz parte.</label>
                    </div>
                </div>
                <div class="flex flex-col">
