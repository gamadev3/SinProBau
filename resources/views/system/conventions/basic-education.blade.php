    ...
    <div class="w-full flex flex-col gap-8 p-7 md:p-10">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div class="w-full sm:w-fit flex justify-between items-center flex-col sm:flex-row gap-2">
                <x-search :url="'educacao-basica'" />

                <a href="/sistema/convencao-formulario/educacao-basica" class="w-full sm:w-2/3 md:w-full h-12 text-white bg-[#138942] hover:bg-[#1B5E1F] focus:ring-4 focus:ring-[#A5D6A7] font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none flex items-center gap-2 self-end">
