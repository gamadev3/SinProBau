...
@section("content")
    <div class="max-w-7xl mx-auto w-full h-full flex flex-col justify-center gap-8 p-7 md:px-20 md:py-20">
        ...
        <form id="form" method="POST" action="/sistema/atualizar-convencao/{{ $convention->id }}" enctype="multipart/form-data" class="w-full md:px-4 py-4">
            @csrf
            @method("POST")
