...
@section("content")
    <div class="max-w-7xl mx-auto w-full min-h-screen flex flex-col justify-center gap-8 p-7 md:px-20 md:py-20">
        <h1 class="text-3xl font-bold text-center">Cadastrar imagem</h1>
        <form id="form" method="POST" action="/sistema/registrar-imagem-carrossel" enctype="multipart/form-data" class="w-full md:px-4 py-4">
            @csrf
            @method("POST")
