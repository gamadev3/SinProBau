@extends(session()->has("firebase_token") && Request::is("system") ? "layouts.system" : "layouts.main")

@section("title", session()->has("firebase_token") && Request::is("system") ? "SINPROBAU - Sistema" : "SINPROBAU")
