...
@section("content")
    <div class="max-w-7xl mx-auto w-full flex flex-col md:flex-row gap-8 p-7 md:p-20">
        ...
        <form id="form" method="POST" action="/enviar-email-contato" class="w-full md:w-1/2 md:px-4 py-4">
            @csrf
